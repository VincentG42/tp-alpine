                ...
                <div className='flex  flex-col gap-1'>
                    {options.equipements.persoInt.declinaison.map((persoInt) =>
                        <div key={persoInt.code} >
                            ...
                            <label htmlFor={persoInt.code} className='flex justify-between gap-2 w-3/5 px-4 py-2' onClick={() => handlepersoIntOptions(persoInt.name, persoInt.price, persoInt.code)}>
