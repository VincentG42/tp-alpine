            ...
            <div id="driveModal" className='bg-slate-100 border border-slate-900 text-slate-900 w-5/6 py-16 flex flex-col gap-8 p-8 relative' >
                ...
                <div className='flex  flex-col gap-1'>
                    ...
                    {options.equipements.persoExt.brakeCaliper.map((caliper) =>
                        <div key={caliper.code}>
                            ...
                            <label htmlFor={caliper.code} className='flex flex-col md:flex-row justify-between gap-2 px-4 py-2 text-sm md:text-base' onClick={() => handleBrakeCaliperChange(caliper.name, caliper.price, caliper.code)}>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div>
                        ...
                        <label htmlFor={options.equipements.persoExt.logo.code} className='flex flex-col md:flex-row justify-between gap-2 px-4 py-2 text-sm md:text-base' onClick={() => handleLogo(options.equipements.persoExt.logo.name, options.equipements.persoExt.logo.price)}>
